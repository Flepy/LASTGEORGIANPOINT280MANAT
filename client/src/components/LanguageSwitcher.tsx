...
export default function LanguageSwitcher({ className = "", mobile = false }: LanguageSwitcherProps) {
  ...
  if (mobile) {
    return (
      <div className={`bg-warm-beige p-4 rounded-lg border border-navy-blue border-opacity-30 ${className}`}>
            ...
            <button
              ...
              className={`text-left px-3 py-2 rounded-md transition-all duration-200 ${
                currentLanguage === lang 
                  ...
                  : 'bg-cream-beige text-navy-blue hover:bg-navy-blue hover:text-white'
              }`}
  ...
  return (
    <div className={`bg-warm-beige px-4 py-2 rounded-lg border border-navy-blue border-opacity-30 ${className}`}>
